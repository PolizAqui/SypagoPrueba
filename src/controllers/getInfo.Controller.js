...
const getInfoController = async (req, res) => {
  try {
    const response = await axios.post(
      'https://sypago.net:8086/api/v1/auth/token',
      {
...
const getOtpController = async (req, res) => {
  try {
    ...
    const response = await axios.post(
      'https://sypago.net:8086/api/v1/request/otp',
      datos, 
      {
        headers: {
          'Content-Type': 'application/json',
...
const bankOptions = async (req, res) => {
  try {
    ...
    const response = await axios.get(
      'https://sypago.net:8086/api/v1/banks',
      {
        headers: {
          'Content-Type': 'application/json',
        }
...
const tasaBank = async(req,res) => {
  try{
    ...
    const response = await axios.get(
    'https://sypago.net:8086/api/v1/bank/bcv/rate',
    {
      headers: {
         'Content-Type': 'application/json',
      }
...
const codeOtp = async (req, res) => {
  try{
    const datos = req.body;
    const response = await axios.post(
      'https://sypago.net:8086/api/v1/transaction/otp',
      datos,
      {
        headers:{
          'Content-Type': 'application/json',
...
const notificationSypago = async (req, res) => {
  try {
    ...
    const response = await axios.get(
      `https://sypago.net:8086/api/v1/transaction/${data}`,
      {
        headers:{
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${accessToken}`
